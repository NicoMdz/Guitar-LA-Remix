...
export async function loader( {request, params}) {
  const { guitarraUrl } = params //de params revisamos y obtenemos el guitarraUrl
  ...
  return guitarra //link especifico de la guitarra
}
    ...
    <div className="guitarra">
      ...
      <div className="contenido">
        ...
        <form onSubmit={handleSubmit} className="formulario">
            ...
            <select 
              onChange={ e => {
                setCantidad(parseInt(e.target.value)) //requerido en numero para cálculos. Otra manera puede ser colocando +e.target.value en vez del parseInt
              }}
              id="cantidad"               
            >
